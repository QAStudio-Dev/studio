<script lang="ts">
	import { Plus, FolderOpen, TestTube2, PlayCircle, Users } from 'lucide-svelte';
	...
	const isProUser = hasTeam && user.team.subscription?.status === 'ACTIVE';
	const projectLimit = isProUser ? Infinity : 1;
