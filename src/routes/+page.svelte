		...
		<div class="mx-auto max-w-5xl text-center">
			...
			>
				...
				>
					...
					<div
						class="absolute inset-0 -z-0 bg-gradient-to-r from-white/90 to-white opacity-0 transition-opacity group-hover:opacity-100"
					></div>
				</a>
				<a
					href="/docs"
			...
			<!-- Feature Pills -->
			<div
				class="flex flex-wrap justify-center gap-3 {mounted
					? 'animate-fade-in animation-delay-300'
					: 'opacity-0'}"
			>
				{#each ['Free to Start', 'Self-Host Option', 'Open Source', 'AI-Powered'] as feature}
					<span
						class="rounded-full border border-white/30 bg-white/5 px-4 py-2 text-sm font-medium text-white backdrop-blur-sm transition-all hover:bg-white/10"
					>
						✓ {feature}
					</span>
				{/each}
	...
	<div class="absolute right-0 bottom-0 left-0">
		<svg class="w-full" viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
				...
				class="dark:fill-[rgb(var(--color-surface-950))]"
			/>
		</svg>
	</div>
</div>
...
<div class="container mx-auto px-4 py-20">
	...
	<!-- Bento Grid -->
	<div
		class="mx-auto grid max-w-6xl grid-cols-1 gap-4 md:auto-rows-fr md:grid-cols-2 lg:grid-cols-3"
	>
	...
	<div class="container mx-auto px-4">
		<div class="mx-auto max-w-4xl text-center">
			...
			<div class="grid gap-6 md:grid-cols-3">
				{#each [{ title: 'Free Tier', desc: 'Start with one project, unlimited test cases, and 10 AI analyses per month. Perfect for trying us out. Attachments retained for 7 days.' }, { title: 'Self-Hosted', desc: 'Deploy on your infrastructure. Unlimited everything including AI features. Your data, your rules.' }, { title: 'Pro Plan ($10/mo)', desc: 'Unlimited projects, team collaboration, unlimited AI trace analysis, priority support, and 30-day attachment retention.' }] as reason}
