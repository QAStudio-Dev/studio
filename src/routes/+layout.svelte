				...
				<div class="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
					...
					<div>
						...
						<ul class="space-y-2 text-sm">
							...
							<li>
								<a href="/projects" class="text-surface-600-400 transition-colors hover:text-primary-500">
									Projects
								</a>
							</li>
							<li>
								<a href="https://github.com" target="_blank" rel="noopener noreferrer" class="text-surface-600-400 transition-colors hover:text-primary-500">
									Self-Hosting Guide
								</a>
							</li>
							<li>
					...
					<div>
						...
						<ul class="space-y-2 text-sm">
							...
							<li>
								<a href="https://discord.com" target="_blank" rel="noopener noreferrer" class="text-surface-600-400 transition-colors hover:text-primary-500">
									Community
								</a>
							</li>
						</ul>
