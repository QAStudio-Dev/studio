...
<div class="container mx-auto max-w-7xl px-4 py-8">
	...
	<Tabs defaultValue="profile">
		...
		<Tabs.Content value="integrations">
			<div class="card p-12 text-center">
				<Plug class="mx-auto mb-4 h-16 w-16 text-surface-400" />
				<h2 class="mb-2 text-2xl font-bold">Integrations Coming Soon</h2>
				<p class="text-surface-600-300 mx-auto max-w-md">
					Connect QA Studio with your favorite tools like Jira, Slack, GitHub, and more.
				</p>
			</div>
		</Tabs.Content>
	</Tabs>
